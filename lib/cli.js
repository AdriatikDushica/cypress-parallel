...
const argv = yargs
  ...
  .option('weights_json_path', {
    alias: 'w',
    type: 'string',
    description: 'Your weights json path'
  })
  .option('threads', {
    alias: 't',
    type: 'number',
...
const WEIGHTS_JSON = argv.weights_json_path ? argv.weights_json_path :'cypress/parallel-weights.json';
